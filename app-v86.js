...
// v85: laad OCR alvast rustig op de achtergrond zodat de eerste echte scan niet voor model-init hoeft te wachten.
if('requestIdleCallback' in window) requestIdleCallback(()=>prewarmOcr(),{timeout:2500});
else setTimeout(prewarmOcr,1400);
if(ocrResult){
