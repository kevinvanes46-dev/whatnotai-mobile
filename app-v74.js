...
function detectSetSymbolLocal(canvas,candidateCards=[]){
  if(!canvas||!photoGuidedCrop)return null; const templates=getSetSymbolTemplates();
...
async function scanCurrentPhoto(){
  ...
  try{
    ...
    // v74 SET SYMBOL RESCUE + SAFE RECONCILE:
